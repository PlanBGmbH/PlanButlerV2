...
{
    public static class GetDailyOrderOverview
    {
        [FunctionName("GetDailyOrderOverview")]
            ...
            ILogger log)
        {
            ...
            var connectionString = string.Empty;// ButlerBot.Util.Settings.StorageAccountConnectionString;
